  ...
  render() {
    return (
      <div className="lannister">
        <img
          className="lannister-logo"
          src={require("../assets/lannister01.jpg")}
        />
        <h1>{this.state.info.name}</h1>
        <h3>"{this.state.info.words}"</h3>
        <p className="lannister-summary">
          House Lannister of Casterly Rock is one of the Great Houses of
          Westeros, one of its richest and most powerful families and one of its
          oldest dynasties. It was also the royal house of the Seven Kingdoms
          following the extinction of House Baratheon of King's Landing, which
          had been their puppet house during the War of the Five Kings, for a
          brief stint of time until House Targaryen took back the Iron Throne in
          Daenerys Targaryen's war for Westeros.
        </p>
        <h5 className="lannister-quote">
          <strong>
            <i>
              "You have to give it to the Lannisters – they may be the most
              pompous, ponderous cunts the gods ever suffered to walk the world,
