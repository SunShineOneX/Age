  ...
  render() {
    return (
      <div className="tyrell">
        ...
        <p className="tyrell-summary">
          House Tyrell of Highgarden is an extinct Great House of Westeros. It
          ruled over the Reach, a vast, fertile, and heavily-populated region of
          southwestern Westeros, from their castle-seat of Highgarden as Lords
          Paramount of the Reach and Wardens of the South after taking control
          of the region from House Gardener during the Targaryen conquest.
        </p>
        <h5 className="tyrell-quote">
          <strong>
            <i>""Growing Strong." Ha! The dullest words of any House.""</i>
          </strong>
          ―Olenna Tyrell
        </h5>
